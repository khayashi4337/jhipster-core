...
const applicationConfigTokens = [
  ...
  // nameとpatternのペア毎のループ

  // それぞれのペアにカテゴリのトークンの設定を保持していく
...
module.exports = {
  ...
  // 指定した定義によるトークンに加えて、このファイルで定義しているオプションのトークンを共通で使えるように指定している
